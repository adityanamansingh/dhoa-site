            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="terms__Sec_wrap">
                        <h2>Terms of Use</h2>
                        <p>
                            This website is operated by onlineups.in. Throughout the site, the terms “we”, “us” and
                            “our” refer to onlineups.in. onlineups.in offers this website, including all information,
                        ...
                        <ul>
                            <li class="list__heading1">ONLINE STORE TERMS</li>
                            ...
                            <p>
                                <b> You must not transmit any worms or viruses or any code of a destructive nature.</b>
                            </p>
                            <p>
                        ...
                        <ul>
                            <li class="list__heading1">GENERAL CONDITIONS</li>
                        ...
                        <ul>
                            <li class="list__heading1">ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</li>
                            <p>
                        ...
                        <ul>
                            <li class="list__heading1">MODIFICATIONS TO THE SERVICE AND PRICES</li>
                        ...
                        <ul>
                            <li class="list__heading1">PRODUCTS OR SERVICES (if applicable)</li>
                            ...
                            <p>
                                ...
                                change at<b>anytime</b> without notice, at the sole discretion of us. We reserve the
                                right to discontinue any product at any time. Any offer for any product or service made
                        ...
                        <ul>
                            <li class="list__heading1">ACCURACY OF BILLING AND ACCOUNT INFORMATION</li>
                            <p>
                        ...
                        <ul>
                            <li class="list__heading1">OPTIONAL TOOLS</li>
                            <p>
                        ...
                        <ul>
                            <li class="list__heading1">THIRD-PARTY LINKS</li>
                            <p>
                        ...
                        <ul>
                            <li class="list__heading1">USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</li>
                            <p>Prices for our products are subject to change without notice.</p>
                            <p>
                                ...
                                forward to us. We are and shall be under no obligation <b>(1) to maintain any comments
                        ...
                        <ul>
                            <li class="list__heading1">PERSONAL INFORMATION</li>
                            <p>
                        ...
                        <ul>
                            <li class="list__heading1">ERRORS, INACCURACIES AND OMISSIONS</li>
                            <p>
                        ...
                        <ul>
                            <li class="list__heading1">PROHIBITED USES</li>
                            <p>In addition to other prohibitions as set forth in the Terms of Service, you are
                                prohibited from using the site or its content: </p>
                            <div class="term_inner_wrap_link">
                                <ul>
                                    <li>(a) For any unlawful purpose</li>
                                    <li>(b) To solicit others to perform or participate in any unlawful acts</li>
                                    <li>(c) To violate any international, federal, provincial or state regulations,
                                        rules, laws, or local ordinances</li>
                                    <li>(d) to infringe upon or violate our intellectual property rights or the
                                    ...
                                    <li>
                                        ...
                                        or may be used in any way that will affect the functionality or operation of the
                                        Service or of any related website, other websites, or the Internet
                                    </li>
                                    <li>
                                        (h) to collect or track the personal information of others; (i) to spam, phish,
                        ...
                        <ul>
                            <li class="list__heading1">DISCLAIMER OF WARRANTIES & LIMITATION OF LIABILITY</li>
                            ...
                            <p>
                                In no case shall onlineups.in, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.
                            </p>
                        </ul>
                        <ul>
                            <li class="list__heading1">INDEMNIFICATION</li>                         
                            <p>
                                You agree to indemnify, defend and hold harmless onlineups.in and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
                            </p>
                        </ul>
                        <ul>
                            <li class="list__heading1">SEVERABILITY</li>                           
                            <p>
                                In the event that any provision of these Terms of Service is determined to be unlawful, void or unenforceable, such provision shall nonetheless be enforceable to the fullest extent permitted by applicable law, and the unenforceable portion shall be deemed to be severed from these Terms of Service, such determination shall not affect the validity and enforceability of any other remaining provisions.
                            </p>
                        </ul>
                        <ul>
                            <li class="list__heading1">TERMINATION</li>
                        ...
                        <ul>
                            <li class="list__heading1">ENTIRE AGREEMENT</li>
                        ...
                        <ul>
                            <li class="list__heading1">GOVERNING LAW</li>
                            <p>These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of <b>4/24 UPSIDC-2 Ajanta Compound Industrial Area Sahibabad Ghaziabad-201007</b></p>
                            <p>
                                We reserve the right at any time to modify or discontinue the Service (or any part or
                                content thereof) without notice at any time.
                            </p>
                        ...
                        <ul>
                            <li class="list__heading1">CHANGES TO TERMS OF SERVICE</li>
                        ...
                        <ul>
                            <li class="list__heading1">CONTACT INFORMATION</li>                          
                            <p>
                                Questions about the Terms of Service should be sent to us at <strong>info@onlineups.in</strong>
                            </p>                           
                        </ul>
                    </div>
                </div>
