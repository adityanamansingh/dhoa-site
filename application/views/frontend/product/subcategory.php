...
$(document).ready(function(){
    ...
    function filter_data(page)
    {
        ...
        var subcatid='<?php echo $this->uri->segment(2);?>';
   
        $.ajax({
            url:"<?php echo base_url(); ?>products/fetch_datasubcat/"+page,
            method:"POST",
            dataType:"JSON",
            data:{action:action,subcatid:subcatid,color_checkbox:color_checkbox,fab_checkbox:fab_checkbox,material_checkbox:material_checkbox,look_checkbox:look_checkbox},
