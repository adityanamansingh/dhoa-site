...
<section class="breacumb_wraps">
    <div class="products_breadcumb">
        <div class="containers">
            <h5 data-aos="fade-right" data-aos-duration="1500">Our Products</h5>
            <p data-aos="fade-right" data-aos-duration="1500">An Exhaustive Range of Luxury Furnishing Solutions That Enhances The Overall Aesthetics of Your Space
 </p>
...
<div class="mobileFilter">
    <div class="fiilterInner">
        <img src="assets/img/filter.png"> Filters
...
<section class="product_mainLisitingWrap"  id="bgblack">
    <div class="grids_prodcts">
         <div class="leftwraps_fillers">
             <div class="mobofilters">
                 <div class="mobofiltertitle">
                     Filters
                 </div>
                 <div class="cancelfilter">
                     <img src="assets/img/cancel (2).png" class="cancel">
                 </div>
             </div>
             <div class="product_filterUiWrap">
    <div class="inner_productsFilter">
        <div class="inner_filterwraps">
            <div class="header_filters hidden-xs">
                <h5>Filters</h5>
            </div>
                ...
                <div class="acc_cards filter_innerWrap">
                    ...
                    <div class="acc__panels">
                        ...
                        <label class="search_filterValue">
                            ...
                            <input class="cat_checkbox common_selector" type="checkbox" value="<?php echo $cats->id;?>">
                            <span class="filter_valueName"><?php echo $cats->category_name;?></span>
                        </label>
                      <?php } } ?>
                    </div>
                </div>
                ...
                <div class="acc_cards filter_innerWrap">
                    ...
                    <div class="acc__panels">
                        ...
                        <label class="search_filterValue">
                            ...
                            <input class="subcat_checkbox common_selector" type="checkbox" value="<?php echo $subcats->id;?>">
                            <span class="filter_valueName"><?php echo $subcats->name;?></span>
                        </label>
                      <?php } } ?>
...
<div class="container bgsin">
        ...
        <div class="col-md-3">
            <div class="any_questionLinkscontact">
                ...
                <a href="<?php echo base_url();?>contact">whatsapp Us</a>
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function(){
    ...
    function filter_data(page)
    {
        ...
        $.ajax({
            ...
            method:"POST",
            dataType:"JSON",
            data:{action:action, cat_checkbox:cat_checkbox, subcat_checkbox:subcat_checkbox, color_checkbox:color_checkbox,fab_checkbox:fab_checkbox,material_checkbox:material_checkbox,look_checkbox:look_checkbox},
