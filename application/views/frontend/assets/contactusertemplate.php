       ...
       <html>
        ...
        <td style="border-bottom:1px solid #eeee;text-align:left;padding: 10px;color: #000;width: 171px;font-weight:bold;font-size: 15px;">
            ...
            <p style="font-weight:400;text-align: center;font-size: 14px;margin-bottom: 0; display:block; width:100%"><b>Thank You  <?php echo $fullname;?> for writing in to us!</b><br>We at DHOA, value your consideration and interest. If required, someone from our team will get in touch with you within 2 to 3 working days.</p>
