...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url();?>admin/color">Color List</a></li>
        <li class="active">Edit</li>
      </ol>
    </section>

    <!-- Main content color Controller-->
            ...
            <form role="form" id="Form1" method="post" enctype="multipart/form-data" action="">
              <div class="box-body">
                  <div class="content">
                    ...
                    <?php 
                    if(isset($record->image) && file_exists(FCPATH."uploads/color/".$record->image) && $record->image!=''){
                        echo '<img src="'.base_url().'uploads/color/'.$record->image.'" width="100px">';
                    }
                    ?>
                  </div>
                </div>
