...
<div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
              <a class="btn btn-primary" href="<?php echo base_url();?>admin/subscriber/export_csv">Export</a> <br>
  ...
  $(function(){
     ...
     $('.delete_button').on('click',function(){
        ...
        var location = "<?php echo urldecode(base_url()."admin/subscriber/delete"); ?>/"+record_id;     
