...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Mature Enquiry List</li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
              <a class="btn btn-primary" href="<?php echo base_url();?>admin/enquiry/export_csv_mature">Export</a> <br> 
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr colspan="3">
                  ...
                  <td>
                  <?php $enquiry_status=$data->status;
                  if($enquiry_status=='pending'){?>
                  <a class="active mature mature_record" href="javascript:" data-record-id="<?php echo $data->id;?>"><i class="fa fa-check" aria-hidden="true"></i></a>
                  <a class="active cancel cancel_record" href="javascript:" data-record-id="<?php echo $data->id;?>"><i class="fa fa-times" aria-hidden="true"></i></a>
                  <?php }
                  if($enquiry_status=='mature'){?>
                    <a class="active pending pending_record" href="javascript:" data-record-id="<?php echo $data->id;?>"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i></a>
                    <a class="active cancel cancel_record" href="javascript:" data-record-id="<?php echo $data->id;?>"><i class="fa   fa-times" aria-hidden="true"></i></a>
                 <?php }
                  if($enquiry_status=='cancel'){?>
                    <a class="active  mature mature_record" href="javascript:" data-record-id="<?php echo $data->id;?>"><i class="fa fa-check" aria-hidden="true"></i></a>
                    <a class="active pending pending_record" href="javascript:" data-record-id="<?php echo $data->id;?>"><i class="fa  fa-exclamation-triangle" aria-hidden="true"></i></a>
                 <?php }?>
                 </td>
